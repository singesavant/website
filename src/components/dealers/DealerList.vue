...
<template lang="html">
  <b-row no-gutters class="dealer-map-container">
      <b-col cols=12>
          ...
          <MglMap :accessToken="accessToken" :mapStyle="mapStyle" :minZoom="minZoom" :maxZoom="maxZoom" :center="center" :pitch="45">
              <MglMarker color="darkblue" v-for="dealer in dealers" :key="dealer.name" :coordinates="dealer.position" :title="dealer.name" :draggable="false" offset="">
                  <!--
                  <v-icon slot="marker">
                      <img src="/images/marker-icon.png" width="40px"/>
                  </v-icon>
                 -->
                  <MglPopup>
                      <div>
